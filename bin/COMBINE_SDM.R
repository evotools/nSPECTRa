...
samps<-read.table("/home/jprende3/Scratch/Allan/individuals.txt", header=T)
samps<-samps[which(samps$GROUP == popu),]

setwd("/home/jprende3/Scratch/Allan/ParsedCounts/")

outFile <- paste("/home/jprende3/Scratch/Allan/filteredChanges.",popu,".RData",sep="")
temp = list.files(pattern=paste("changes.",popu,"*", sep=""))
...
colnames(dat)<-c("Chr", "Pos1", "Id1", "Pos2", "Id2", "Dist", "Null", "Cons1", "Cons2", "Anc1", "Anc2", "SameCodon", "StartF", "Mid1F", "Mid2F", "EndF", "StartC", "Mid1C", "Mid2C", "EndC", "Inds")
